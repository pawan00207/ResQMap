...
export function ReportForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setSuccess(true)
        setFormData({ report_type, title, description)
        setTimeout(() => {
          setSuccess(false)
          setIsOpen(false)
        }, 2000)
    ...
    <>
      {!isOpen && (
        <button
          ...
          className="fixed bottom-24 right-6 bg-blue-600 hover
        >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, report_type)
                    }
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>
                    Location{location.latitude.toFixed(4)}, ${location.longitude.toFixed(4)}` : 'Getting...'}
                  </span>
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 bg-blue-600 text-white py-2 rounded hover:bg-blue-700 disabled
                  >
                  ...
                  <button
                    ...
                    className="flex-1 bg-gray-300 text-gray-800 py-2 rounded hover
                  >
                    Cancel
                  </button>
                </div>
